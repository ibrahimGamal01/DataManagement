...
const Timeline = () => {
    return (
        <>
            <section className="mb-2 overflow-hidden flex items-center justify-center" >
                <div className="bg-black text-white py-8">
                    <div className="container mx-auto flex flex-col items-start md:flex-row my-12 md:my-24">
                        <div className="flex flex-col w-full sticky md:top-36 lg:w-1/3 mt-2 md:mt-12 px-8">
                            ...
                            {/* <a href="#" className="inline-flex items-center justify-center px-4 py-2 mr-auto text-base font-medium text-white rounded-lg bg-transparent hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 border border-blue-500 hover:text-white hover:border-transparent dark:focus:ring-primary-900 transition ease-in-out delay-150 bg-gradient-to-br from-blue-900 to-blue-500 hover:-translate-y-1 hover:scale-10 hover:from-indigo-900 hover:to-indigo-600 duration-300 shadow hover:shadow-lg">
                                Explore Now
                                <svg
                            ...
                            <div className="container mx-auto w-full h-full" >
                                <div className="relative wrap overflow-hidden p-10 h-full">
                                    <RevealOnScroll >
                                        ...
                                        {/* <div className="border-2-2 border-yellow-555 absolute h-full border" style={{ left: '50%', border: '2px solid #0442c8', borderRadius: '16%' }}></div> */}
                                    </RevealOnScroll>
            ...
            >
                <div
                    className="relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-[#5357b9] to-[#24bea2] opacity-30 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem]"
                    style={{
                        clipPath:
