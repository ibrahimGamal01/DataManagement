...
const Timeline = () => {
    return (
        <section className="mb-2 overflow-hidden flex items-center justify-center max-w-screen-xl mx-auto px-4 md:px-0">
            <div className="text-white py-8">
                <div className="container mx-auto flex flex-col items-start md:flex-row my-12 md:my-24">
                    <div className="flex flex-col w-full sticky md:top-36 lg:w-1/3 mt-2 md:mt-12">
                        <p className="ml-2 text-blue-600 uppercase tracking-loose">Working Process</p>
                        ...
                        <div className='inline-flex items-center justify-center py-2 mr-auto'>
                            ...
                            >
                                Get started
                                <span className='ml-1 font-bold hover:translate-x-1 hover:text-blue-600 transition-transform duration-300'>
                                    <svg
                                        id="Capa_1"
                                        fill='currentColor'
                                        viewBox='0 0 15 15'
                        ...
                        <div className="container mx-auto w-full h-full">
                            <div className="relative wrap overflow-hidden p-10 h-full">
                                ...
                                <div className="mb-8 flex justify-between flex-row-reverse items-center w-full left-timeline">
                                    ...
                                    <div className="order-1 w-5/12 px-4 py-4 text-right">
                                ...
                                <div className="mb-8 flex justify-between items-center w-full right-timeline">
                                    <div className="order-1 w-5/12"></div>
                                    <div className="order-1 w-5/12 px-4 py-4 text-left">
                                        <p className="mb-3 text-base text-blue-600">6-9 May, 2021</p>
                                ...
                                <div className="mb-8 flex justify-between flex-row-reverse items-center w-full left-timeline">
                                    <div className="order-1 w-5/12"></div>
                                    <div className="order-1 w-5/12 px-4 py-4 text-right">
                                        <p className="mb-3 text-base text-blue-600"> 10 May, 2021</p>
                                ...
                                <div className="mb-8 flex justify-between items-center w-full right-timeline">
                                    <div className="order-1 w-5/12"></div>
                                    <div className="order-1 w-5/12 px-4 py-4">
                                        <p className="mb-3 text-base text-blue-600">12 May, 2021</p>
